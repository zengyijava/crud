...
public class OracleGenerator {
    ...
    private static final String database = "emp1.5";
    private static final String oracleDatabase = "ORCL1";
    private static final String url = "jdbc:mysql://192.169.1.80:3306/" + database  + "?useUnicode=true&useSSL=false&characterEncoding=utf8";
    private static final String oracleUrl = "jdbc:oracle:thin:@192.169.1.32:1521:" + oracleDatabase;
    ...
    public static void main(String[] args) {
        List<String> tableNames = Arrays.asList("MON_MSGDELAY_DYNAMIC", "MON_BUS_DYNAMIC", "MON_PUSH_DYNAMIC");
        generate("shenliufei", "com.montnets.emp.common", tableNames, "");
    }
    ...
    private static DataSourceConfig initDataSourceConfig() {
        return new DataSourceConfig()
                .setUrl(oracleUrl)
                .setDriverName(oracleDriverName)
    ...
    private static GlobalConfig initGlobalConfig(String author, String packageName) {
        ...
        String tmp = OracleGenerator.class.getResource("").getPath();
        String codeDir = "";
        if (tmp != null) {
    ...
    public static class JdbcRepository {
        ...
        public JdbcRepository() {
            DataSource dataSource = DataSourceBuilder.create()
                    ...
                    .driverClassName(oracleDriverName)
                    .url(oracleUrl)
                    .username(userName)
                    .password(word)
                    .build();
